...
import com.hdlink.online.adapter.TextAdapter;
...
public class ViewLeft extends RelativeLayout implements ViewBaseAction{
	...
	private final String[] items = new String[] { "全部区域", "福田区", "罗湖区", "南山区", "宝安区", "龙岗区" };//显示字段
	private final String[] itemsVaule = new String[] { "1", "2", "3", "4", "5", "6" };//隐藏id
	private OnSelectListener mOnSelectListener;
	private TextAdapter adapter;
	private String mDistance;
	private String showText = "全部区域";
	...
	private void init(Context context) {
		...
		adapter = new TextAdapter(context, items, R.drawable.choose_item_right9, R.drawable.choose_eara_item_selector);
